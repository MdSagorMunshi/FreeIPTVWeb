  ...
  return (
    <div className="flex flex-col h-full space-y-6 md:space-y-10 pb-32 md:pb-12">
      ...
      <header className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
        <div>
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black tracking-tight mb-2 md:mb-4 flex items-center gap-4">
            <Globe2 className="text-blue-500 hidden sm:block" size={64} />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-300">Global TV</span>
          </h1>
        ...
        <div className="relative group w-full lg:w-[400px] xl:w-[500px]">
          <div className="absolute inset-y-0 left-0 pl-5 flex items-center pointer-events-none">
            <Search className="h-5 w-5 md:h-6 md:w-6 text-zinc-500 group-focus-within:text-blue-400 transition-colors" />
          </div>
          <input
            type="text"
            className="w-full pl-14 pr-6 py-4 md:py-5 text-base md:text-lg bg-zinc-900/50 border border-zinc-800 rounded-3xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all glass placeholder-zinc-500 text-white shadow-xl shadow-black/20"
              ...
              >
                <div className="aspect-video bg-black/40 flex items-center justify-center p-3 md:p-4 relative">
                  {channel.logo ? (
                    ...
                    <Globe2 className="w-12 h-12 md:w-16 md:h-16 text-zinc-700" />
                  )}
      ...
      {filteredChannels.length === 0 && (
        <div className="flex flex-col items-center justify-center py-32 text-zinc-500">
          ...
          <p className="text-2xl md:text-3xl font-black text-white">No regions found</p>
